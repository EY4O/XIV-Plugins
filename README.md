...
> **Current status:** RePlate 0.6.1.3 and Bagcheck 0.5.0 are available. AutoTataru is still in testing and not in the repository yet.
...
| --- | --- | --- |
| RePlate | Release 0.6.1.3 | [Plugin page](https://ey4o.github.io/XIV-Plugins/plugins/replate/) |
